...
(async () => {
  ...
  try {
    const foo = await page.goto(`https://accounts.google.com/o/saml2/initsso?idpid=${argv.googleIdpId}&spid=${argv.googleSpId}&forceauthn=false`)

    if (/ServiceLogin/.test(foo.url())) {
